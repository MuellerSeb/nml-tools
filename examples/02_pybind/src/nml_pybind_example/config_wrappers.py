...
class Config:
    ...
    def set_dims(
        ...
        if n_weights is not None:
            ...
            kwargs["n_weights"] = 0
        kwargs["has_n_weights_"] = n_weights is not None
    ...
    def set(
        ...
        if name is not None:
            ...
            kwargs["name"] = ""
        kwargs["has_name_"] = name is not None
        if enabled is not None:
            kwargs["enabled"] = enabled
        else:
            kwargs["enabled"] = False
        kwargs["has_enabled_"] = enabled is not None
        ...
        kwargs["has_weights_"] = weights is not None
